    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
            ...
            <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                ...
                <ul class="menu-nav">
                    <li
                        class="menu-item menu-item-submenu {{ Route::currentRouteNamed('super.dashboard.*') ? 'menu-item-active' : '' }}">
                        <a href="{{ route('super.dashboard.index') }}" class="menu-link">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
                            ...
                            <div class="d-flex flex-center pt-7">
                                <a href="{{ route('logout') }}"
                                    class="btn btn-light-danger font-weight-bold text-center"
                            ...
                            <div class="navi navi-hover scroll my-4" data-scroll="true" data-height="300"
                                ...
                                <a href="#" class="navi-item">
                                    <div class="navi-link">
                                        ...
                                        <div class="navi-text">
                                            <div class="font-weight-bold">System reboot has been successfully completed
                                            </div>
